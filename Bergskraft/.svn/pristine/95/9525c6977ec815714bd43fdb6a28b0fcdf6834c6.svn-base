...
OpenLayers.Control.PanZoom = OpenLayers.Class(OpenLayers.Control, {
    ...
    */
    draw: function(px) {
        ...
        var centered = new OpenLayers.Pixel(px.x+60 + sz.w / 2-60, px.y-20);
        
        //old xepto
        //var centered = new OpenLayers.Pixel(px.x + sz.w / 2, px.y);
        //end of xepto

        this._addButton("panup", "zoompan_up.png", centered, sz);
        px.y = centered.y + (sz.h / 2);
        px.x = px.x - (sz.w / 2);
        ...
        //        this._addButton("panleft", "zoompan_left.png", px, sz);
        //        this._addButton("panright", "zoompan_right.png", px.add(sz.w, 0), sz);
        //        this._addButton("pandown", "zoompan_down.png",
