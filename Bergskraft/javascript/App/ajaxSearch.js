...
Bergis.Search.objectView = function (sXml) {
    ...
    $(".ReportButton").click(function () {
        ...
        var arrDataNumber = buttonId[12];
        var depositDataNumber = buttonId[14];
        var arrArray = arrData[arrDataNumber];
        arrArray.Deposits = [];
        arrArray.Deposits[0] = depositData[depositDataNumber];
        Bergis.Search.postHtml = arrArray;
