...
OpenLayers.Layer.GeoRSS = OpenLayers.Class(OpenLayers.Layer.Markers, {
    ...
    */
    initialize: function (name, location, options) {
        ...
        this.features = [];
        $("<div id='selectControlTitleOnHover'><span></span></div>").appendTo("body");
        $("#selectControlTitleOnHover").hide();
    },
...
//            var point = new OpenLayers.LonLat(feature.lonlat.lon, feature.lonlat.lat);
//            point.transform(new OpenLayers.Projection("EPSG:900913"), new OpenLayers.Projection("EPSG:4326"));
            ...
            $("#" + marker.icon.imageDiv.id).css({ 'cursor': 'pointer' });
        }
        //if (features.length == 1) {
        //    this.map.setCenter(new OpenLayers.LonLat(features[0].geometry.x,features[0].geometry.y),9);
        //}
        var geo = this.getDataExtent();
        if (geo != null) {
    ...
    */
    markerOver: function (evt) {
        ...
        //    var lonLat = new OpenLayers.LonLat(this.geometry.x, this.geometry.y);
        //}
        //var lonLat = new OpenLayers.LonLat(this.geometry.x, this.geometry.y);
        var screenPx = this.layer.map.getPixelFromLonLat(this.lonlat);
        if (this.data.title != "") {
            $("#selectControlTitleOnHover span").text(this.data.title);
            $("#selectControlTitleOnHover").css({ left: screenPx.x + 13 + "px", top: screenPx.y + 62 + "px" }).show();
        }
        //var sameMarkerClicked = (this == this.layer.selectedFeature);
        //this.layer.selectedFeature = (!sameMarkerClicked) ? this : null;
    ...
    markerOut: function () {
        $("#selectControlTitleOnHover").hide();
        $("#selectControlTitleOnHover span").text("");
    },
